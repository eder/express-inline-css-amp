...
var InlineCSSAMP = exports.InlineCSSAMP = function () {
  function InlineCSSAMP(_ref) {
    var CSSPathBase = _ref.CSSPathBase,
        CSSFilePath = _ref.CSSFilePath,
        _ref$CSSMinify = _ref.CSSMinify,
        CSSMinify = _ref$CSSMinify === undefined ? true : _ref$CSSMinify,
        fileByRoutes = _ref.fileByRoutes,
  ...
  (0, _createClass3.default)(InlineCSSAMP, [{
    ...
    key: 'generateCSS',
    value: function generateCSS(byRoutes) {
      var _this = this;
    ...
    key: 'generateCSSByRoutes',
    value: function generateCSSByRoutes() {
      var _this3 = this;

      this.fileByRoutes.map(function (route) {
        _this3.outFile = '' + _this3.CSSPathBase + route;
        _this3.CSSFilePath = '' + _this3.CSSPathBase + route;
        console.log(_this3.outFile, _this3.CSSFilePath);
      });
    }
  }, {
    key: 'run',
...
module.exports = function (object) {
  ...
  var render = function render(req, res, next) {
    var renderCallback = function renderCallback(view) {

      return function (err, html) {
        inlinecss.run(view).then(function (content) {
